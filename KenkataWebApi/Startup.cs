...
{ 
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCors();
            services.AddDbContext<KenkataDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("SqlConnection")));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "KenkataWebApi", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "KenkataWebApi v1");
